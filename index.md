...
<style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .resume-panel { display: flex; flex-direction: column; gap: 0.9rem; justify-content: center; padding: 1.1rem; border-radius: 18px; background: #0f172a; color: #e2e8f0; box-shadow: 0 18px 42px rgba(15,23,42,0.15); }
    .resume-panel-title { display: flex; align-items: center; gap: 0.5rem; font-size: 0.92rem; font-weight: 760; color: #bfdbfe; }
    .resume-actions { display: grid; gap: 0.7rem; }
    .resume-link { width: 100%; display: flex; justify-content: space-between; align-items: center; gap: 0.8rem; text-align: left; border: 1px solid rgba(148,163,184,0.28); background: rgba(255,255,255,0.06); color: #f8fafc; border-radius: 12px; padding: 0.85rem 0.95rem; cursor: pointer; }
    ...
    .resume-link em { font-style: normal; font-size: 0.78rem; color: rgba(226,232,240,0.78); }
    ...
    @media (max-width: 768px) {
        ...
        .capability-item summary { grid-template-columns: 1fr; }
