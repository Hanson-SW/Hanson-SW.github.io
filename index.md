...
<div id="page-wrapper">
    ...
    <div class="cv-container" id="main-content-container">
        <section class="hero-dashboard">
            <div class="header-section">
                ...
                <div class="identity-block">
                    <div class="hero-kicker" data-i18n="hero_kicker">Financial Engineering Portfolio</div>
                    <h1 class="main-title" data-i18n="name">王 盛 烨</h1>
                    <p class="sub-title">
                        <i class="fas fa-chart-line"></i> <span data-i18n="degree">上海纽约大学 · 商业与金融（商业分析）</span>
                    </p>
                    <div class="contact-wrapper hero-contact">
            ...
            <div class="resume-panel">
                <div class="resume-panel-title">
                    ...
                    <span data-i18n="resume_title">我的简历</span>
                </div>
                <div class="resume-actions">
                    <button onclick="window.open('王盛烨简历.pdf', '_blank')" class="resume-link primary btn-bubble">
                        <span><strong data-i18n="resume_name">金融工程简历 (中文版)</strong><em data-i18n="resume_tag">· 2026 最新版</em></span>
                        <i class="fas fa-arrow-up-right-from-square"></i>
                    </button>
                    <button onclick="window.open('SWresume.pdf', '_blank')" class="resume-link btn-bubble">
                        <span><strong data-i18n="resume_en_name">金融工程简历 (English)</strong><em data-i18n="resume_en_tag">· 2026 Updated</em></span>
                        <i class="fas fa-arrow-up-right-from-square"></i>
                    </button>
                </div>
            </div>
        ...
        <h2 class="section-title" style="margin-top: 3.5rem;">
            <i class="fas fa-layer-group"></i> <span data-i18n="capability_title">技术与研究能力</span>
        </h2>
        <div class="capability-board">
            <details class="capability-item glass-card">
                <summary><span data-i18n="cap_data_title">数据可信化</span><em data-i18n="cap_data_keys">JSON行情库 · Manifest · Quality Report · 缓存容灾</em></summary>
                <p data-i18n="cap_data_desc">data/*.json 存储宽基、黄金、半导体、医药等资产；asset_manifest.json 统一资产名称、区间、更新时间和可用性；quality_report.json 跟踪缺失、失败和缓存状态。</p>
            </details>
            <details class="capability-item glass-card">
                <summary><span data-i18n="cap_quant_title">量化研究</span><em data-i18n="cap_quant_keys">MPT · Risk Parity · Black-Litterman · CVaR · 有效前沿</em></summary>
                <p data-i18n="cap_quant_desc">覆盖组合优化、风险贡献、压力测试、参数敏感性、样本外检验和策略归因，重点展示金融工程建模链路。</p>
            </details>
            <details class="capability-item glass-card">
                <summary><span data-i18n="cap_report_title">报表分析建模</span><em data-i18n="cap_report_keys">三表清洗 · Ratio · DCF · Comps · LBO · AI Mock Report</em></summary>
                <p data-i18n="cap_report_desc">statement-analyzer.html 展示财务报表标准化、核心指标、估值、交易建模和报告生成能力，补足量化之外的投研表达。</p>
            </details>
            <details class="capability-item glass-card">
                <summary><span data-i18n="cap_front_title">前端工程</span><em data-i18n="cap_front_keys">纯前端部署 · ECharts · 双语 · 响应式 · 报告导出</em></summary>
                <p data-i18n="cap_front_desc">模型运行在 GitHub Pages 环境中，强调快速反馈、缓存兜底、移动端兼容、双语切换和可下载报告。</p>
            </details>
        </div>
            ...
            <div class="param-grid">
                <div class="grid-col-span-2 relative-box">
                    ...
                    <div class="flex-input-group">
                        <input type="text" id="stockTicker" value="AAPL" oninput="handleLocalSearch(); markCustom();" onkeydown="handleAutocompleteKeydown(event)" autocomplete="off" autocapitalize="none" spellcheck="false" aria-autocomplete="list" aria-controls="autocompleteList" aria-expanded="false" class="param-input uppercase-text mono-font" placeholder="输入 AAPL 或指数代码..." />
                    ...
                    <div id="autocompleteList" class="autocomplete-dropdown" role="listbox"></div>
                </div>
...
<style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .cv-container {
        width: min(1480px, calc(100vw - 48px)); margin: 0 auto; padding: 2rem 0 3rem;
    ...
    /* ================= 基础 UI 样式 ================= */
    .top-utility-bar { display: flex; justify-content: flex-end; width: min(1480px, calc(100vw - 48px)); margin: 0 auto 0.5rem; padding-top: 1rem; position: relative; z-index: 10;}
    ...
    .hero-dashboard { display: grid; grid-template-columns: minmax(0, 1.45fr) minmax(360px, 0.55fr); gap: 1.1rem; align-items: stretch; margin-bottom: 2.3rem; padding: 1.1rem 0 1.35rem; border-bottom: 1px solid rgba(148,163,184,0.24); }
    .header-section { display: flex; align-items: center; gap: 1.35rem; flex-wrap: nowrap; min-width: 0; padding: 1.3rem 1.4rem; border-radius: 18px; background: linear-gradient(135deg, rgba(255,255,255,0.82), rgba(239,246,255,0.72)); border: 1px solid rgba(226,232,240,0.82); box-shadow: 0 18px 42px rgba(15,23,42,0.05); }
    .avatar-gradient { width: 86px; height: 86px; border-radius: 24px; background: linear-gradient(135deg, #0f172a, #2563eb 58%, #14b8a6); display: flex; align-items: center; justify-content: center; font-size: 2.1rem; font-weight: 700; color: white; flex-shrink: 0; box-shadow: 0 14px 28px rgba(37, 99, 235, 0.22); }
    .identity-block { min-width: 0; }
    .hero-kicker { color: #2563eb; font-size: 0.76rem; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 0.28rem; }
    .main-title { font-size: clamp(2.15rem, 3.2vw, 3.4rem); font-weight: 780; margin: 0; letter-spacing: 0px; display: block; line-height: 1.02; }
    ...
    .resume-panel { display: flex; flex-direction: column; gap: 0.9rem; justify-content: center; padding: 1.1rem; border-radius: 18px; background: #ffffff; color: #0f172a; border: 1px solid rgba(226,232,240,0.82); box-shadow: 0 18px 42px rgba(15,23,42,0.05); }
    .resume-panel-title { display: flex; align-items: center; gap: 0.5rem; font-size: 0.92rem; font-weight: 760; color: #2563eb; }
    .resume-actions { display: grid; gap: 0.7rem; }
    .resume-link { width: 100%; display: flex; justify-content: space-between; align-items: center; gap: 0.8rem; text-align: left; border: 1px solid rgba(203,213,225,0.82); background: #f8fafc; color: #0f172a; border-radius: 12px; padding: 0.85rem 0.95rem; cursor: pointer; }
    .resume-link.primary { background: linear-gradient(135deg, #2563eb, #14b8a6); border-color: transparent; }
    .resume-link.primary strong { color: #ffffff; }
    .resume-link.primary em { color: #e0f2fe; }
    .resume-link span { display: grid; gap: 0.16rem; min-width: 0; }
    .resume-link strong { font-size: 0.92rem; line-height: 1.25; overflow-wrap: anywhere; }
    .resume-link em { font-style: normal; font-size: 0.78rem; color: #64748b; }
    ...
    .project-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 1rem; margin-bottom: 1rem; align-items: stretch; }
    .project-card { border-radius: 12px; padding: 1.2rem; display: flex; flex-direction: column; gap: 1rem; transition: transform 0.2s, box-shadow 0.2s, border-color 0.2s; box-shadow: none; min-height: 390px; border-top: 5px solid #2563eb !important; }
    .project-card:nth-child(2) { border-top-color: #8b5cf6 !important; }
    .project-card:nth-child(3) { border-top-color: #14b8a6 !important; }
    .project-card:hover { transform: translateY(-4px); box-shadow: 0 16px 35px rgba(15, 23, 42, 0.09); border-color: rgba(148,163,184,0.55) !important; }
    .project-card .header { display: flex; flex-direction: column; gap: 0.6rem; }
    .project-card .title { font-size: clamp(1rem, 1.15vw, 1.2rem); font-weight: 760; color: #0f172a; line-height: 1.28; min-height: 2.7em; }
    .project-card .tag { align-self: flex-start; background: #eef2ff; color: #4f46e5; padding: 0.24rem 0.68rem; border-radius: 999px; font-size: 0.78rem; font-weight: 700; border-left: 0; }
    .project-card:nth-child(1) .tag { background: #eff6ff; color: #2563eb; }
    .project-card:nth-child(2) .tag { background: #f5f3ff; color: #7c3aed; }
    .project-card:nth-child(3) .tag { background: #ecfdf5; color: #059669; }
    .project-meta { display: grid; gap: 0.58rem; font-size: 0.86rem; color: #475569; line-height: 1.48; }
    .project-meta div { display: grid; grid-template-columns: 3.15rem 1fr; gap: 0.5rem; align-items: start; padding-bottom: 0.52rem; border-bottom: 1px solid rgba(226,232,240,0.72); }
    ...
    .project-card .project-btn { width: 100%; background: #0f172a; color: white; border: none; box-shadow: none; font-size: 0.92rem; padding: 0.62rem 1rem; border-radius: 10px; }
    .project-card:nth-child(1) .project-btn { background: #2563eb; }
    .project-card:nth-child(2) .project-btn { background: #7c3aed; }
    .project-card:nth-child(3) .project-btn { background: #059669; }
    .project-card .project-btn:hover { filter: brightness(0.96); }
    ...
    .capability-board { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0.85rem; margin-bottom: 1rem; }
    .capability-item { border-radius: 14px; padding: 0; overflow: hidden; }
    .capability-item summary { list-style: none; cursor: pointer; padding: 1rem 1.1rem; display: grid; grid-template-columns: 150px 1fr auto; gap: 0.8rem; align-items: center; }
    .capability-item summary::-webkit-details-marker { display: none; }
    .capability-item summary span { font-weight: 750; color: #0f172a; }
    .capability-item summary em { font-style: normal; color: #64748b; font-size: 0.86rem; line-height: 1.45; }
    .capability-item summary::after { content: "+"; justify-self: end; color: #2563eb; font-weight: 800; grid-column: 3; }
    .capability-item[open] summary::after { content: "−"; }
    .capability-item p { margin: 0; padding: 0 1.1rem 1rem; color: #475569; line-height: 1.6; font-size: 0.92rem; }

    /* ================= 模型面板及其他组件 ================= */
    .model-panel { border-radius: 14px; padding: 1.2rem; margin-bottom: 1rem; box-shadow: none; }
    ...
    .relative-box:focus-within { z-index: 1000; }
    .autocomplete-dropdown { display:none; position:absolute; top: 100%; left: 0; right: 0; background: rgba(255,255,255,0.98); backdrop-filter: blur(10px); border: 1px solid #cbd5e1; border-radius: 8px; margin-top: 4px; max-height: min(220px, 42vh); overflow-y: auto; overscroll-behavior: contain; z-index: 999; box-shadow: 0 10px 25px rgba(0,0,0,0.1); }
    .autocomplete-item { display:block; width:100%; padding: 10px 12px; cursor: pointer; border:0; border-bottom: 1px solid rgba(0,0,0,0.05); border-radius:0; text-align:left; background:#fff; font-size: 0.85rem; color: #334155; line-height: 1.4; }
    .autocomplete-item:hover, .autocomplete-item.active { background: #eff6ff; color: #2563eb; }

    .chart-wrapper { border-radius: 12px; padding: 1rem; border: 1px solid rgba(226,232,240,0.8); box-shadow: none; position: relative; margin-bottom: 1.5rem; width: 100%; overflow: hidden; }
    ...
    .hero-contact { margin-top: 0.8rem; }
    ...
    @media (max-width: 768px) {
        .cv-container { width: calc(100vw - 20px); padding: 1rem 0 2rem; }
        .top-utility-bar { width: calc(100vw - 20px); }
        ...
        .flex-input-group { display: grid; grid-template-columns: minmax(0, 1fr) auto; }
        .flex-input-group .fetch-btn { width: auto; min-width: 76px; padding: 0 0.8rem; }
        .param-input, #aiSearchInput { min-width: 0; font-size: 16px; }
        .project-grid, .capability-board { grid-template-columns: 1fr; }
        .capability-item summary { grid-template-columns: minmax(0, 1fr) auto; }
        .capability-item summary span { grid-column: 1; grid-row: 1; }
        .capability-item summary em { grid-column: 1; grid-row: 2; }
        .capability-item summary::after { grid-column: 2; grid-row: 1 / span 2; align-self: center; }
    ...
    @media (max-width: 480px) {
        ...
        .grid-col-span-2, .grid-col-btn { grid-column: auto; }
        .main-title { font-size: 2.15rem; }
        .hero-dashboard { gap: 0.8rem; }
        .header-section, .resume-panel, .model-panel, .chart-wrapper { padding-left: 0.9rem; padding-right: 0.9rem; }
        .autocomplete-dropdown { right: 0; max-height: 36vh; }
    }
</style>
...
<script>
    ...
    const i18nDict = {
        ...
        hero_kicker: { zh: "Financial Engineering Portfolio", en: "Financial Engineering Portfolio" },
        ...
        capability_title: { zh: "技术与研究能力", en: "Technical & Research Capabilities" },
        cap_data_title: { zh: "数据可信化", en: "Data Reliability" },
        cap_data_keys: { zh: "JSON行情库 · Manifest · Quality Report · 缓存容灾", en: "JSON market store · Manifest · Quality report · Cache fallback" },
        cap_data_desc: { zh: "data/*.json 存储宽基、黄金、半导体、医药等资产；asset_manifest.json 统一资产名称、区间、更新时间和可用性；quality_report.json 跟踪缺失、失败和缓存状态。", en: "data/*.json stores broad indices, gold, semiconductors, healthcare and other assets; asset_manifest.json manages names, ranges, update times and availability; quality_report.json tracks missing data, failures and cache status." },
        cap_quant_title: { zh: "量化研究", en: "Quant Research" },
        cap_quant_keys: { zh: "MPT · Risk Parity · Black-Litterman · CVaR · 有效前沿", en: "MPT · Risk Parity · Black-Litterman · CVaR · Efficient frontier" },
        cap_quant_desc: { zh: "覆盖组合优化、风险贡献、压力测试、参数敏感性、样本外检验和策略归因，重点展示金融工程建模链路。", en: "Covers portfolio optimization, risk contribution, stress testing, parameter sensitivity, out-of-sample checks and strategy attribution to show the financial-engineering workflow." },
        cap_report_title: { zh: "报表分析建模", en: "Statement Analytics" },
        cap_report_keys: { zh: "三表清洗 · Ratio · DCF · Comps · LBO · AI Mock Report", en: "Statement cleaning · Ratios · DCF · Comps · LBO · AI mock report" },
        cap_report_desc: { zh: "statement-analyzer.html 展示财务报表标准化、核心指标、估值、交易建模和报告生成能力，补足量化之外的投研表达。", en: "statement-analyzer.html demonstrates statement standardization, key metrics, valuation, deal modeling and report generation, adding research presentation beyond quant models." },
        cap_front_title: { zh: "前端工程", en: "Front-end Engineering" },
        cap_front_keys: { zh: "纯前端部署 · ECharts · 双语 · 响应式 · 报告导出", en: "Static deployment · ECharts · Bilingual UI · Responsive · Exportable reports" },
        cap_front_desc: { zh: "模型运行在 GitHub Pages 环境中，强调快速反馈、缓存兜底、移动端兼容、双语切换和可下载报告。", en: "The models run on GitHub Pages, emphasizing fast feedback, cache fallback, mobile compatibility, bilingual switching and downloadable reports." },
    ...
    function handleLocalSearch() {
        ...
        if(q.length < 1) { listDiv.style.display = 'none'; input.setAttribute('aria-expanded', 'false'); return; }
        
        let results = localTickerDB.filter(item => item.symbol.includes(q) || item.name.toUpperCase().includes(q));
        if(results.length > 0) {
            let html = results.map(item => 
                `<button type="button" class="autocomplete-item" role="option" data-symbol="${item.symbol}" onclick="selectTicker('${item.symbol}')">
    ...
    function handleAutocompleteKeydown(event) {
        ...
        if (event.key === 'ArrowDown' || event.key === 'ArrowUp') {
            ...
            autocompleteActiveIndex = (autocompleteActiveIndex + direction + items.length) % items.length;
            items.forEach((item, index) => item.classList.toggle('active', index === autocompleteActiveIndex));
            items[autocompleteActiveIndex].scrollIntoView({ block: 'nearest' });
        } else if (event.key === 'Enter' && autocompleteActiveIndex >= 0) {
            event.preventDefault();
            selectTicker(items[autocompleteActiveIndex].dataset.symbol);
        } else if (event.key === 'Escape') {
            list.style.display = 'none';
            document.getElementById('stockTicker').setAttribute('aria-expanded', 'false');
        }
    }
    ...
    function runSimulation() {
        ...
        setTimeout(() => {
            ...
            chartInstance.setOption({
                ...
                graphic: [{ type: 'text', left: '2%', top: '3%', style: { text: watermarkText, fontSize: 10, fill: '#64748b', lineHeight: 15, fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace' }, z: 100 }],
                tooltip: {
                ...
                xAxis: { type: 'category', data: xAxisData, axisLabel: { fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace' } },
                yAxis: [
                    { type: 'category', data: data.yAxisLabels, show: false }, 
                    { type: 'value', min: data.globalMin, max: data.globalMax, axisLabel: { fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace', formatter: function(v) { return currentCurrency + parseFloat(v).toFixed(2); } } }
                ],
                series: [
